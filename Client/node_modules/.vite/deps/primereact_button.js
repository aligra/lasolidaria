    ...
    var setMetaData = function setMetaData2() {
      ...
      var sx = function sx2() {
        ...
        if (when) {
          ...
          var base = getOptionValue(inlineStyles2, key, _objectSpread({
            props: props2,
            state
          }, params));
...
var Ripple = React3.memo(React3.forwardRef(function(inProps, ref) {
  ...
  return context && context.ripple || PrimeReact.ripple ? React3.createElement("span", _extends2({
    role: "presentation",
    ref: inkRef
  }, rootProps, {
    onAnimationEnd
...
var classes3 = {
  ...
  root: function root3(_ref3) {
    ...
    }, _defineProperty4(_classNames2, "p-button-loading-".concat(props.iconPos), props.loading && props.label), _defineProperty4(_classNames2, "p-button-".concat(size), size), _defineProperty4(_classNames2, "p-button-".concat(props.severity), props.severity), _classNames2));
  }
};
